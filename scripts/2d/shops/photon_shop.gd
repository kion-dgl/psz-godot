...
const EXCHANGE_ITEMS := [
	...
	{"name": "Fire Photon", "id": "fire_photon", "cost": 2, "category": "Photon Crystals"},
	{"name": "Ice Photon", "id": "ice_photon", "cost": 2, "category": "Photon Crystals"},
	{"name": "Poison Photon", "id": "poison_photon", "cost": 2, "category": "Photon Crystals"},
	{"name": "Shock Photon", "id": "shock_photon", "cost": 2, "category": "Photon Crystals"},
	{"name": "Devil Photon", "id": "devil_photon", "cost": 2, "category": "Photon Crystals"},
